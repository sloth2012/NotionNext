...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '在知识的海洋里挖啊挖~~~, CTRL+C && CTRL+V，then you get the world！🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '哒鸽', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '吾不生产知识，只做知识的搬运工😁', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-pi-navy.vercel.app', // 网站地址
