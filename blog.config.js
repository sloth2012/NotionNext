...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '在知识的海洋里挖啊挖~~~, CTRL+C and CTRL+V，then you get the whole world！🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '哒鸽', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '知识的搬运工😁', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://dage110.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'NLP, 阅读笔记, 随笔', // 网站关键词 英文逗号隔开
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '哒鸽的博客', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  ...
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '哒鸽的情怀分享', // 站点描述，被notion中的页面描述覆盖
